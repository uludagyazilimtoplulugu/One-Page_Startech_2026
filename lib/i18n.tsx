...
const translations = {
  tr: {
    ...
    mentor: "Mentör",
    back: "Geri",
    eventDate: "28 Mart 2026",
    eventTime: "12:00 - 17:00",
    eventVenue: "Mete Cengiz Kültür Merkezi",
    ...
    faqExperienceRoomsAnswer:
      "Mülakat Simülasyonu: Sektör profesyonelleriyle birebir deneme görüşmesi yapıp anında geri bildirim alırsın. Case Study: Şirketlerin gerçek problemleri üzerinde beyin fırtınası ve takım çalışması.",
    ...
    gamificationSubtitle: "Her tanışma bir fırsat, her puan bir adım.",
  ...
  en: {
    ...
    faqExperienceRoomsAnswer:
      "Interview Simulation: One-on-one practice interviews with industry professionals and instant feedback. Case Study: Brainstorming and teamwork on real company problems.",
    ...
    gamificationSubtitle: "Every meeting is an opportunity, every point is a step forward.",
